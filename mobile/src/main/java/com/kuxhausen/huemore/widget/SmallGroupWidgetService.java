...
public class SmallGroupWidgetService extends RemoteViewsService {

  @Override
  public RemoteViewsFactory onGetViewFactory(Intent intent) {
    return new SmallGroupStackRemoteViewsFactory(this.getApplicationContext(), intent);
  }
}
 ...
 */
@TargetApi(Build.VERSION_CODES.HONEYCOMB)
class SmallGroupStackRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {

  private Context mContext;
  private Cursor mCursor;
  private int mAppWidgetId;

  public SmallGroupStackRemoteViewsFactory(Context context, Intent intent) {
    mContext = context;
    mAppWidgetId =
  ...
  public RemoteViews getViewAt(int position) {
    ...
    final int itemId = R.layout.widget_small_group_row;
