...
public class DiskBasedCache implements Cache {
  ...
  /*
   * Homebrewed simple serialization system used for reading and writing cache headers on disk. Once
   * upon a time, this used the standard Java Object{Input,Output}Stream, but the default
   * implementation relies heavily on reflection (even for standard types) and generates a ton of
   * garbage.
   */

  /**
   * Simple wrapper around {@link InputStream#read()} that throws EOFException instead of returning
   * -1.
   */
