...
/* package */final class Constants {
   ...
   */
  /*
   * This is NOT a public API. Third party apps should NOT use this log tag for their own log
   * messages.
   */
   ...
   */
  /*
   * This is NOT a public API. Third parties should NOT rely on this being the only package name for
   * Locale.
   */
