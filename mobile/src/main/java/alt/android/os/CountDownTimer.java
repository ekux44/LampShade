 ...
 * </pre>
 * 
 * The calls to {@link #onTick(long)} are synchronized to this object so that one call to
 * {@link #onTick(long)} won't ever occur before the previous callback is complete. This is only
