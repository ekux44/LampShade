...
/*
 * The original code said: <p> I am placing this code in the Public Domain. Do with it as you will.
 * This software comes with no guarantees or warranties but with plenty of well-wishing instead!
 * Please visit <a href="http://iharder.net/xmlizable">http://iharder.net/xmlizable</a> periodically
...
public class Base64 {
  ...
  private final static byte[] WEBSAFE_DECODABET = {-9, -9, -9, -9, -9, -9, -9, -9, -9, // Decimal 0
                                                                                       // - 8
      -5, -5, // Whitespace: Tab and Linefeed
      -9, -9, // Decimal 11 - 12
      -5, // Whitespace: Carriage Return
