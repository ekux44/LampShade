...
public class IabHelper {
   ...
   *        verification of purchase signatures. You can find your app's base64-encoded public key
   *        in your application's page on Google Play Developer Console. Note that this is NOT your
  ...
  public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
      ...
      if (purchaseData == null || dataSignature == null) {
        ...
        result =
            new IabResult(IABHELPER_UNKNOWN_ERROR,
      ...
      try {
        ...
        if (!Security.verifyPurchase(mSignatureBase64, purchaseData, dataSignature)) {
          ...
          result =
              new IabResult(IABHELPER_VERIFICATION_FAILED, "Signature verification failed for sku "
                  + sku);
          if (mPurchaseListener != null)
