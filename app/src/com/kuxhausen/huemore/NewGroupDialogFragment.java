...
public class NewGroupDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        rayAdapter = new ArrayAdapter<String>(this.getActivity(),android.R.layout.simple_list_item_multiple_choice,dummyArrayItems);
        ...
        builder.setPositiveButton(R.string.accept, new DialogInterface.OnClickListener() {
                   public void onClick(DialogInterface dialog, int id) {
                	   ...
                	   ((MainActivity)getActivity()).helper.addGroup(groupname, checkedItems.toArray(new String[checkedItems.size()]));
                   }
               })
