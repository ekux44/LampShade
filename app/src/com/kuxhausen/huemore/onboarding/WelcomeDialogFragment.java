...
public class WelcomeDialogFragment extends DialogFragment implements OnClickListener {
  ...
  public void onClick(View v) {
    switch (v.getId()) {
      ...
      case R.id.getHueButton:
        ...
        String url =
            "http://www.amazon.com/gp/product/B00BSN8DN4/ref=as_li_qf_sp_asin_il_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B00BSN8DN4&linkCode=as2&tag=lampshio-20";
